            ...
            <div className="w-full max-w-md p-8 rounded-2xl glass-panel bg-[#31323e] shadow-2xl relative overflow-hidden ring-1 ring-[#bfc0d1]/10">
                ...
                <div className="relative z-10">
                    <div className="text-center mb-10">
                        <h1 className="text-3xl font-bold tracking-wider text-white mb-2">FleetFlow</h1>
                        <p className="text-sm text-[#8b8c9d]">Logistics Management System</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-1">
                            <div className="flex justify-between items-center">
                                ...
                                <a href="#" className="text-xs text-[#60519b] hover:text-[#7b6ac6] transition-colors">
                                    Forgot Password?
                                </a>
                            </div>
                            <input
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-[#31323e] px-2 text-[#8b8c9d]">Or continue with</span>
                            </div>
                        </div>
                    ...
                    <p className="text-center mt-8 text-sm text-[#8b8c9d]">
                        Don't have an account?{" "}
                        <Link href="/signup" className="text-[#60519b] hover:text-[#7b6ac6] font-semibold">
                            Sign up
                        </Link>
                    </p>

                    <p className="text-center mt-4 text-xs text-[#8b8c9d]">
                        Secure access based on organizational role. <br />
