        ...
        <div className="px-6 py-8">
            ...
            >
                <div className="w-16 h-16 rounded-2xl bg-[#60519b]/10 flex items-center justify-center mb-6">
                    <Wrench className="text-[#60519b] w-8 h-8" />
                </div>
                <h1 className="text-3xl font-bold mb-4">Maintenance Logs</h1>
                <p className="text-[#8b8c9d] max-w-lg mb-8">
                    Log preventative and reactive maintenance records. Linking a vehicle here automatically pauses its trip dispatch capability.
                </p>
                ...
                <div className="w-full max-w-4xl h-64 border border-dashed border-white/10 rounded-2xl flex items-center justify-center text-[#8b8c9d]/50 bg-[#31323e]/20">
                    Component Workspace: Insert Maintenance Records Display
                </div>
            </motion.div>
        </div>
    );
