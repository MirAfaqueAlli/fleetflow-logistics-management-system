        ...
        <div className="px-6 py-8">
            ...
            >
                <div className="w-16 h-16 rounded-2xl bg-[#60519b]/10 flex items-center justify-center mb-6">
                    <Activity className="text-[#60519b] w-8 h-8" />
                </div>
                <h1 className="text-3xl font-bold mb-4">Driver Performance & Safety</h1>
                <p className="text-[#8b8c9d] max-w-lg mb-8">
                    Monitor your human resources, compliance records (license expiries), and view automated safety scorecards.
                </p>
                ...
                <div className="w-full max-w-4xl h-64 border border-dashed border-white/10 rounded-2xl flex items-center justify-center text-[#8b8c9d]/50 bg-[#31323e]/20">
                    Component Workspace: Insert HR & Driver Tables Here
                </div>
            </motion.div>
        </div>
    );
