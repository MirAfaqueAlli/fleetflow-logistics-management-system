                ...
                <form onSubmit={handleDispatch} className="space-y-6 max-w-4xl">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                            ...
                            >
                                ...
                                {availableVehicles.map((v: any) => (
                                    <option key={v.id} value={v.id}>{v.name} (Max: {v.maxLoadCapacity}kg)</option>
                                ))}
                            </select>
                        </div>
                    ...
                    <div className="pt-6 border-[var(--card-border)]">
                        <button
                            type="submit"
                            disabled={isPending}
                            className="px-8 py-3 rounded-xl border border-[var(--primary)] bg-[var(--primary)]/10 text-[var(--foreground)] font-semibold hover:bg-[var(--primary)] hover:text-white transition-all shadow-[0_4px_14px_0_rgba(96,81,155,0.2)] hover:shadow-[0_6px_20px_rgba(96,81,155,0.4)] flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
